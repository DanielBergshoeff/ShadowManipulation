...
public class Node {
    ...
    public int iGridZ;//Z Position in the Node Array
    ...
    public Node(bool a_bIsWall, Vector3 a_vPos, int a_igridX, int a_igridY, int a_igridZ)//Constructor
    {
        ...
        iGridZ = a_igridZ;//Z position in the Node Array
    }
